...
//   document.querySelector('#emails-view').innerHTML = `<h3 className="pl-2 content-center text-xl">${mailbox.charAt(0).toUpperCase() + mailbox.slice(1)}</h3>`;
...
//     document.querySelector('#email-view').innerHTML = `<h1 className="pl-2 content-center text-2xl">${element.subject}</h3>`;
